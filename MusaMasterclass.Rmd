...
A 2640x2640 matrix is easily processed in R, but it's not ideal here for two reasons:

1) Large matrices like this take a while to display in 3D.
2) We're time limited, and the resolution isn't important to the analysis.

So we'll use another rayshader function, `reduce_matrix_size()`, to cleanly reduce the resolution of the matrix. Here, we're reducing it by half. 
